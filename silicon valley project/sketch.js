...
function preload() {
  ...
  c1Img= loadImage("images/1.png");
  c2Img= loadImage("images/2.png");
  c3Img= loadImage("images/3.png");
...
if(mousePressedOver(c6)){
  ...
  if(a===1 && b===1 || a===1 && c===1 || a===1 && d===1 || a===1 && f===1){
   lifeTime=lifeTime-1;
   restart.visible=true;
  }

  if(b===1 && d===1 || b===1 && e===1 || b===1 && f===1){
    lifeTime=lifeTime-1;
    restart.visible=true;
  }

  if(c===1 && d===1 || c===1 && e===1 || c===1 && f===1){
    lifeTime=lifeTime-1;
    restart.visible=true;
  }
